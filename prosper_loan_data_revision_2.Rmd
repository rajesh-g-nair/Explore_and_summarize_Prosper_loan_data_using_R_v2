...
```{r echo=FALSE, message=FALSE, warning=FALSE, Univariate_Plots, fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
dim(pld)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, CA_Dataset, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, New_Derived_variables, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
# New Variable Derived for Home Ownership   
# This derived variable will be used to analyze the data for 2 groups of borrowers i.e., Borrowers having Own home and Borrowers staying in Rented Homes  

pldca$HomeOwnership <- ifelse(pldca$IsBorrowerHomeowner == 'True',
                              'OwnHome','RentedHome')

# New Variable Derived for Credit Grade
# On reviewing the data it was observed that for closed loans the Credit Grade is Present in the field CreditGrade and for the in Progress loans, the Credit Grade is in the field ProsperRating_Alpha. In order to have a complete view of the data across all credit grades it was decided to derive this new column for Credit Grade which will have value for both Closed and In Progress loans
...
# On reviewing the data it was observed that there are many different Occupations. It would be difficult to make any understanding of the data if we consider each occupation individually as there would be a large number of data points to look at. Also, the number of cases for some of the occupations would be very few to actually reflect any true trend for the Occupation. Hence, we decided to group the related Occupations by deriving a new variable. By this way we would have more number of cases in a group and it will provide a better trend as compared to when considering individual occupation
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_Credit_Grade_Derived, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_Income_range, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_Term, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_Loan_Status, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_Borrower_Rate, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_Lender_Yield, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_Occupation, fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_Employment_Status, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_Loan_Original_Amount, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_GrossPrincipalLoss, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_TradesNeverDelinquent_percentage, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_DebtToIncomeRatio, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_of_HomeOwnership, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Bivariate_Plots,fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/' }
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Histogram_BorrowerRate_facetwrap_CreditGrade,fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, LenderYield_CreditGrade,fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, LoanStatus_CreditGrade,fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
# Log Transforming the Y-axis
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Homeownership_CreditGrade, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Homeownership_TradesNeverDelinquentpercent,fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Homeownership_DebtToIncomeRatio,fig.width=12, fig.height=8,, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, scatterplot_occupation_TradesNeverDelinquent, fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}

# Create a subset for cases which never had Delinquent Trades 
pdlca_occupation_tradesneverdelinquent <- 
  subset(pldca,TradesNeverDelinquent_percentage == 1)
# Set the order of the levels of Occupation in the ascending order of their 
# Count 
pdlca_occupation_tradesneverdelinquent <- 
  transform( pdlca_occupation_tradesneverdelinquent,
       Occupation_Derived = ordered(Occupation_Derived, 
                                    levels = names( sort(table(
                                                        Occupation_Derived)))))

p9 <- ggplot(data=subset(pdlca_occupation_tradesneverdelinquent,
                          Occupation_Derived != 'NA' ),
                          aes(x=Occupation_Derived))+
      geom_bar()+
      scale_y_log10()+
      xlab("Occupation")+
...
# Create a subset for cases which had Delinquent Trades 
pdlca_occupation_tradesdelinquent <- 
  subset(pldca,TradesNeverDelinquent_percentage < 1)
# Calculating the median per category
pdlca_occupation_tradesdelinquent = 
  ddply(pdlca_occupation_tradesdelinquent, 
        .(Occupation_Derived), 
        mutate, 
        mdn = median(TradesNeverDelinquent_percentage)
        )
# Order according to Median
# Set the order of the levels according to the median for Using in the plot
pdlca_occupation_tradesdelinquent$Occupation_Derived =
  factor(pdlca_occupation_tradesdelinquent$Occupation_Derived,
         levels = pdlca_occupation_tradesdelinquent$Occupation_Derived[
           order(pdlca_occupation_tradesdelinquent$mdn)],ordered = TRUE)

pdlca_occupation_tradesdelinquent$Occupation_Derived <-
  factor(pdlca_occupation_tradesdelinquent$Occupation_Derived[,drop=TRUE])

p10 <- ggplot(data=subset(pdlca_occupation_tradesdelinquent,
                          Occupation_Derived != 'NA' ),
...
The Occupations "Aviation" and "Car Dealer" have more Trade Delinquencies as compared to other Trades with their mean around 25% (The mean of trades not Delinquent is around 75% for these 2 groups implying 25% Delinquency). For these 2 groups the number of Trades never Delinquent is also very low. Followed by these 2 groups are the groups "Realtor", "Religious" and "Home Maker" which have higher Delinquency with mean around 20% and these groups also have very low number of Trades which were never Delinquent.

The Occupations "Other", "Professional", "Clerical", "Computer" and "Sales" have more number of non Delinquent Trades as compared to other Occupations


```{r echo=FALSE, message=FALSE, warning=FALSE, scatterplot_MonthlyIncome_Loan_Amount, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, scatterplot_MonthlyIncome_DebttoIncomeRatio, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, scatterplot_LoanAmount_DebttoIncomeRatio, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, scatterplot_LenderYield_DebttoIncomeRatio, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, scatterplot_TradesNeverDelinquentPctg_DebttoIncomeRatio, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, scatterplot_MonthlyIncome_LenderYield, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, scatterplot_MonthlyIncome_TradesNeverDelinquent, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, scatterplot_BorrowerRate_LenderYield, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, scatterplot_LoanOriginalAmount_LenderYield, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Multivariate_Plots, fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, ClosedLoan_CreditGrade_HomeOwnership_Loanstatus, fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, ClosedLoan_CreditGrade_HomeOwnership_PrincipalLossPctg, fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, Summarize_using_dplyr, fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, dataset_wide_format, fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
### Plot One
```{r echo=FALSE, message=FALSE, warning=FALSE, Plot_One, fig.width=12, fig.height=8}
...
#### Summary:
1. The Occupations "Aviation" and "Car Dealer" have more Trade Delinquencies as compared to other Occupations followed by "Realtor", "Religious" and "Home Maker". This indicates that it might be riskier to lend loan to these Occupations   
   
2. The Occupations "Other", "Professional", "Clerical", "Computer" and "Sales" have more number of non Delinquent Trades as compared to other Occupations. This indicates that it might be safer to lend loan to these Occupations


### Plot Two
```{r echo=FALSE, message=FALSE, warning=FALSE, Plot_Two, fig.width=12, fig.height=8, cache=TRUE, cache.path = 'cache/', fig.path='figure/'}
...
#### Summary:
For higher Credit Ratings lending to Rented Home Borrowers seems more safer and for lower Credit Ratings lending to Own Home Borrowers seems more safer 

### Plot Three
```{r echo=FALSE, message=FALSE, warning=FALSE, Plot_Three, fig.width=12, fig.height=8}
grid.arrange(p1,p2,p3,p4)
...
#### Summary:
1. The loan amount decreases from higher to lower Credit grades (AA-HR) with Owned home borrowers getting a slightly higher loan amount as compared to the Rented Home borrowers   
   
2. The Lender Yield increases from higher to lower Credit grades (AA-HR)

3. The Trade delinquency increases from higher to lower Credit grades (AA-HR) with Own Home borrowers having a slightly lesser delinquency than Rented home borrowers

4. The Principal Loss increases from higher to lower Credit grade (AA-HR). For the higher Credit grades (AA-C) the principal loss is higher for Own Home borrowers and for lower Credit grades (E-HR) it is higher for Rented Home borrowers
...
There are certain occupations which have more Trade Delinquencies as compared to others. The Occupations "Aviation" and "Car Dealer" have more Trade Delinquencies as compared to other Trades with their mean around 25%. Followed by these 2 groups are the groups "Realtor", "Religious" and "Home Maker" which have higher Delinquency with mean around 20%. All these groups also have very low number of Trades which were never Delinquent. The Occupations "Other", "Professional", "Clerical", "Computer" and "Sales" have more number of non Delinquent Trades as compared to other Occupations
...
By using the features Credit Grade, Home Ownershp, Principal Loss, Loan Amount, Occupation, Income Range we can construct a model to derive the output feature Trade Delinquency and Lender Yield. By building such a model we would be able to  assess the risk reward trade off for a particular case
